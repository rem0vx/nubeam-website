...
export const metadata = {
  ...
  description: 'Get warm introductions to Family Offices, VC, PE, and Hedge Funds. nuBeam Gen connects founders to $3T+ in capital networks. $57M+ in team transaction experience. By application only.',
  keywords: [
  ...
  openGraph: {
    title: 'nuBeam Gen — Founder Capital Advisory & Investor Introductions',
    description: 'Warm introductions to Family Offices, VC, PE, and Hedge Funds. $3T+ capital network. $57M+ in team transaction experience.',
    url: 'https://nubeam.io',
    siteName: 'nuBeam Gen',
    type: 'website',
  },
